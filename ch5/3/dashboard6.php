...
<div class="modal fade" id="addElements" tabindex="1" role="dialog" 
 ...
 <!---- Red Flag Modal -->
<div class="modal fade" id="selectRanges" tabindex="-1" role="dialog" aria-labelledby="selectRanges"
 aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addAtt">Select Date Ranges</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
       <div class="modal-body">
            <div class="row">
                ...
                <div class="col"><input type="text" id="startDate"></div>
            </div>
            <div class="row">
                <div class="col-3">End Date:</div>
                <div class="col"><input type="text" id="endDate"></div>
            </div>
            <div class="row">
                <div class="col-3">CID:</div>
               <div class="col"> <input type="text" id="selectedCID"></div>
            </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button onclick="showRedFlags()" type="button" class="btn btn-primary">Show Red Flags</button>
      </div>
    </div>
  </div>
</div>
